...
void u_cat_ui_l(mpz_t& dst, unsigned long val, mp_bitcnt_t bitcnt1, mpz_t& src,
                mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val);
...
void u_cat_ui2(mpz_t& dst, unsigned long val1, mp_bitcnt_t bitcnt1, unsigned long val2,
               mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val1);
  mpz_mul_2exp(dst, dst, bitcnt2);
...
void u_pad_ui(mpz_t& dst, unsigned long src, mp_bitcnt_t n) { mpz_set_ui(dst, src); }
...
void u_shr_ui(mpz_t& dst, unsigned long src, unsigned long n) { mpz_set_ui(dst, src >> n); }
...
void u_add_ui_l(mpz_t& dst, unsigned long val, mp_bitcnt_t bitcnt1, mpz_t& src,
                mp_bitcnt_t bitcnt2) {
...
void u_add_ui2(mpz_t& dst, unsigned long val1, mp_bitcnt_t bitcnt1, unsigned long val2,
               mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val1);
  mpz_add_ui(dst, dst, val2);
}
...
void u_sub_ui_l(mpz_t& dst, unsigned long val, mp_bitcnt_t bitcnt1, mpz_t& src,
                mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val);
  mpz_sub(dst, dst, src);
}
...
void u_sub_ui2(mpz_t& dst, unsigned long val1, mp_bitcnt_t bitcnt1, unsigned long val2,
               mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val1);
...
void u_mul_ui_l(mpz_t& dst, unsigned long val, mp_bitcnt_t bitcnt1, mpz_t& src,
                mp_bitcnt_t bitcnt2) {
...
void u_mul_si_r(mpz_t& dst, mpz_t& src, long val, mp_bitcnt_t bitcnt) { mpz_mul_si(dst, src, val); }

void u_mul_ui2(mpz_t& dst, unsigned long val1, mp_bitcnt_t bitcnt1, unsigned long val2,
               mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val1);
...
void u_div_ui_l(mpz_t& dst, unsigned long val, mp_bitcnt_t bitcnt1, mpz_t& src,
                mp_bitcnt_t bitcnt2) {
...
void u_div_ui2(mpz_t& dst, unsigned long val1, mp_bitcnt_t bitcnt1, unsigned long val2,
               mp_bitcnt_t bitcnt2) {
  if (val2 == 0) return;
...
void u_rem_ui_l(mpz_t& dst, unsigned long val, mp_bitcnt_t bitcnt1, mpz_t& src,
                mp_bitcnt_t bitcnt2) {
  if (mpz_cmp_ui(src, 0) == 0) return;
  mpz_set_ui(dst, val);
...
void u_rem_ui2(mpz_t& dst, unsigned long val1, mp_bitcnt_t bitcnt1, unsigned long val2,
               mp_bitcnt_t bitcnt2) {
  if (val2 == 0) return;
  mpz_set_ui(dst, val1 % val2);
}
...
void u_lt_ui_l(mpz_t& dst, unsigned long val, mp_bitcnt_t bitcnt1, mpz_t& src,
               mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, mpz_cmp_ui(src, val) > 0);
}

void u_lt_ui2(mpz_t& dst, unsigned long val1, mp_bitcnt_t bitcnt1, unsigned long val2,
              mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val1 < val2);
}
...
void u_leq_ui_l(mpz_t& dst, unsigned long val, mp_bitcnt_t bitcnt1, mpz_t& src,
                mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, mpz_cmp_ui(src, val) >= 0);
}

void u_leq_ui2(mpz_t& dst, unsigned long val1, mp_bitcnt_t bitcnt1, unsigned long val2,
               mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val1 <= val2);
}
...
void u_gt_ui_l(mpz_t& dst, unsigned long val, mp_bitcnt_t bitcnt1, mpz_t& src,
               mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, mpz_cmp_ui(src, val) < 0);
}

void u_gt_ui2(mpz_t& dst, unsigned long val1, mp_bitcnt_t bitcnt1, unsigned long val2,
              mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val1 > val2);
}
...
void u_geq_ui_l(mpz_t& dst, unsigned long val, mp_bitcnt_t bitcnt1, mpz_t& src,
                mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, mpz_cmp_ui(src, val) <= 0);
}

void u_geq_ui2(mpz_t& dst, unsigned long val1, mp_bitcnt_t bitcnt1, unsigned long val2,
               mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val1 >= val2);
}
...
void u_eq_ui_l(mpz_t& dst, unsigned long val, mp_bitcnt_t bitcnt1, mpz_t& src,
               mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, mpz_cmp_ui(src, val) == 0);
}

void u_eq_ui2(mpz_t& dst, unsigned long val1, mp_bitcnt_t bitcnt1, unsigned long val2,
              mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val1 == val2);
}
...
void u_neq_ui_l(mpz_t& dst, unsigned long val, mp_bitcnt_t bitcnt1, mpz_t& src,
                mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, mpz_cmp_ui(src, val) != 0);
}
void u_neq_ui2(mpz_t& dst, unsigned long val1, mp_bitcnt_t bitcnt1, unsigned long val2,
               mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val1 != val2);
}
// and
...
void u_and_ui_l(mpz_t& dst, unsigned long val, mp_bitcnt_t bitcnt1, mpz_t& src,
                mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val);
  mpz_and(dst, dst, src);
}
void u_and_ui2(mpz_t& dst, unsigned long val1, mp_bitcnt_t bitcnt1, unsigned long val2,
               mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val1 & val2);
}
// ior
...
void u_or_ui_l(mpz_t& dst, unsigned long val, mp_bitcnt_t bitcnt1, mpz_t& src,
               mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val);
  mpz_ior(dst, dst, src);
}
void u_or_ui2(mpz_t& dst, unsigned long val1, mp_bitcnt_t bitcnt1, unsigned long val2,
              mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val1 | val2);
}
// xor
...
void u_xor_ui_l(mpz_t& dst, unsigned long val, mp_bitcnt_t bitcnt1, mpz_t& src,
                mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val);
  mpz_xor(dst, dst, src);
}
void u_xor_ui2(mpz_t& dst, unsigned long val1, mp_bitcnt_t bitcnt1, unsigned long val2,
               mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val1 ^ val2);
}
// dshl
...
void u_dshl_ui_l(mpz_t& dst, unsigned long val, mp_bitcnt_t bitcnt1, mpz_t& src,
                 mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val);
  mpz_mul_2exp(dst, dst, mpz_get_ui(src));
}
void u_dshl_ui2(mpz_t& dst, unsigned long val1, mp_bitcnt_t bitcnt1, unsigned long val2,
                mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val1 << val2);
}
// dshr
...
void u_dshr_ui_l(mpz_t& dst, unsigned long val, mp_bitcnt_t bitcnt1, mpz_t& src,
                 mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val >> mpz_get_ui(src));
}
void u_dshr_ui2(mpz_t& dst, unsigned long val1, mp_bitcnt_t bitcnt1, unsigned long val2,
                mp_bitcnt_t bitcnt2) {
  mpz_set_ui(dst, val1 >> val2);
}
// orr
...
void s_cvt_ui(mpz_t& dst, unsigned long src, mp_bitcnt_t bitcnt) { mpz_set_ui(dst, src); }
